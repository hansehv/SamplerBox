...
#
	...
	def do_POST(self):
		...
		if "SB_Scale" in fields:
			specials.append("Scale")
			scalechange=( UI.Scale() != UI.Scale(int(fields["SB_Scale"][0])) )
		if "SB_Chord" in fields:
			specials.append("Chord")
			if not scalechange:
